                ...
                <div class="card-form mb-3 m-auto">
                    <div class="row">
                        <div class="col d-none d-lg-block">
                            <img src="./assets/img/rh1.jpg" class="img-fluid img-form" id="img" alt="RH" min-height="200px" style="height: 100%;">
                        </div>
                            ...
                            <span class="logo">
                                ...
                                <form method="POST" action="${pageContext.request.contextPath}/register" class="register-form">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <select id="jobTitle" class="form-select" name="jobTitle">
                                            <option value="">Please select</option>
                                            <% List<JobTitle> jobTitles = (List<JobTitle>) request.getAttribute("jobTitles");
                                                for (JobTitle jobTitle : jobTitles) { %>
                                            <option value="<%= jobTitle.getTitle_id() %>"><%= jobTitle.getTitle_name() %></option>
                                            <% } %>
                                        </select>
                                    </div>
                                    <div class="mb-3">
